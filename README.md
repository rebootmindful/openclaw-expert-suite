...
**9位专业 Agent + 智能调度系统**，帮你从多个维度深度分析复杂问题。
...
└─────────────────────────────────────────────────────────┘
   ...
   └────────┘ └────────┘ └────────┘ └────────┘ └────────┘
        ↓         ↓         ↓         ↓
   ┌────────┐ ┌────────┐ ┌────────┐
   │ Human3 │ │ Naval  │ │Tiandao │ │Strategist│
   │发展评估│ │纳瓦尔策略│ │天道思维│ │战略顾问  │
   └────────┘ └────────┘ └────────┘ └──────────┘
                           ↓
┌─────────────────────────────────────────────────────────┐
│              综合各方观点 → 输出最终答案                 │
...
| **tiandao** | 天道思维 | 强势文化破局、文化属性诊断、客观规律洞察 | "为什么我总在困境里打转" |
| **strategist** | 个人战略顾问 | 数据本体论、三层框架、个人价值最大化 | "帮我制定长期发展规划" |
...
├── tiandao/SOUL.md       # 复制 tiandao.md 内容 (v2.1新增)
└── strategist/SOUL.md    # 复制 strategist.md 内容 (v2.1新增)
```
...
| **命运破局** | tiandao + thinker + naval | 文化诊断+本质挖掘+策略 |
| **强者思维** | tiandao + coach | 文化重塑+思维训练 |
...
深度解码《天道》和《遥远的救世主》中丁元英的思想，帮你剖析困境，找到破局之路。

**核心理念：**
- **强势文化**：遵循事物规律，独立思考，主动"造势"和"用势"
- **弱势文化**：依赖强者，思想上"等、靠、要"，期待救世主
- **天道**：不以人的意志为转移的客观规律

**核心能力：**
- 文化属性诊断：分析你的思维模式是"强势"还是"弱势"
- 困境破局：从"等靠要"到主动创造"势"
- 客观规律洞察：尊重规律、利用规律，而非祈求
- 认知重塑：从"依赖者"到"主导者"的转变
